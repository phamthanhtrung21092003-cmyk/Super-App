...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  { id: 'tx_4', title: 'Nạp tiền vào ví V-life', desc: 'Từ thẻ Vietcombank **** 1234', amount: '+500.000đ', type: 'in', date: '05 Tháng 7, 10:00', icon: 'card-outline', bg: '#D1FAE5', color: '#10B981' },
  ...
  { id: 'tx_10', title: 'V-life khuyến mãi', desc: 'Quà tặng chào mừng siêu ứng dụng', amount: '+50.000đ', type: 'in', date: '20 Tháng 6, 08:00', icon: 'gift-outline', bg: '#D1FAE5', color: '#10B981' }
];
...
const generateTransactionsList = (): Transaction[] => {
  ...
  const senders = [
    ...
    { title: 'Công ty V-life', desc: 'Thưởng chiến dịch V-life AI Star' }
  ];
