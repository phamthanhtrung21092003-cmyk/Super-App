    ...
    <View style={styles.webWrapper}>
      <SafeAreaView style={[styles.safeArea, isDesktop && styles.desktopFrame]}>
        ...
        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 110 }}>
          ...
          <View style={styles.listCard}>
            <TouchableOpacity style={[styles.listItem, { borderBottomWidth: 0 }]} onPress={() => setShowSettings(true)}>
              <View style={[styles.listIconBox, { backgroundColor: '#F1F5F9' }]}>
                <Ionicons name="settings-outline" size={18} color="#64748B" />
              </View>
              <Text style={[styles.listItemTitle, { fontFamily: theme.fontFamily, fontWeight: '700' }]}>Cài đặt hệ thống</Text>
              <Ionicons name="chevron-forward" size={16} color="#CBD5E1" />
            </TouchableOpacity>
          </View>
        </ScrollView>
        ...
        <Modal visible={showSettings} transparent animationType="slide">
          <View style={styles.modalOverlay}>
            ...
            <BlurView intensity={95} tint="dark" style={styles.sheetContent}>
              <View style={styles.sheetHandle} />
              <View style={styles.sheetHead}>
                <Text style={[styles.sheetTitle, { fontFamily: theme.fontFamily }]}>Cài đặt hệ thống</Text>
                <TouchableOpacity onPress={() => setShowSettings(false)}>
                  <Ionicons name="close" size={22} color="#0F172A" />
                </TouchableOpacity>
              </View>

              <ScrollView style={{ paddingHorizontal: 16, paddingTop: 10, paddingBottom: 40 }}>
                {/* Setting 1: Thông báo */}
                <TouchableOpacity style={styles.settingsItem} onPress={() => showToast('Cài đặt Thông báo')}>
                  <View style={[styles.listIconBox, { backgroundColor: '#FFFBEB' }]}>
                    <Ionicons name="notifications-outline" size={18} color="#F59E0B" />
                  </View>
                  <Text style={styles.settingsItemText}>Thông báo</Text>
                  <Ionicons name="chevron-forward" size={16} color="#CBD5E1" />
                </TouchableOpacity>

                {/* Setting 2: Quyền riêng tư */}
                <TouchableOpacity style={styles.settingsItem} onPress={() => showToast('Cài đặt Quyền riêng tư')}>
                  <View style={[styles.listIconBox, { backgroundColor: '#EFF6FF' }]}>
                    <Ionicons name="lock-closed-outline" size={18} color="#3B82F6" />
                  </View>
                  <Text style={styles.settingsItemText}>Quyền riêng tư</Text>
                  <Ionicons name="chevron-forward" size={16} color="#CBD5E1" />
                </TouchableOpacity>

                {/* Setting 3: Giao diện */}
                <TouchableOpacity style={styles.settingsItem} onPress={() => showToast('Cài đặt Giao diện')}>
                  <View style={[styles.listIconBox, { backgroundColor: '#F5F3FF' }]}>
                    <Ionicons name="color-palette-outline" size={18} color="#8B5CF6" />
                  </View>
                  <Text style={styles.settingsItemText}>Giao diện</Text>
                  <Ionicons name="chevron-forward" size={16} color="#CBD5E1" />
                </TouchableOpacity>

                {/* Setting 4: Trợ giúp */}
                <TouchableOpacity style={styles.settingsItem} onPress={() => showToast('Trung tâm Trợ giúp V-life')}>
                  <View style={[styles.listIconBox, { backgroundColor: '#F1F5F9' }]}>
                    <Ionicons name="help-circle-outline" size={18} color="#64748B" />
                  </View>
                  <Text style={styles.settingsItemText}>Trợ giúp &amp; Hỗ trợ</Text>
                  <Ionicons name="chevron-forward" size={16} color="#CBD5E1" />
                </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  logoutBtn: {
    ...
    marginTop: 24, borderWidth: 1, borderColor: '#FEE2E2',
  },
