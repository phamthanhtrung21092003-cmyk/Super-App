    ...
    <View style={styles.webWrapper}>
      <SafeAreaView style={[styles.safeArea, isDesktop && styles.desktopFrame]}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { fontFamily: theme.fontFamily }]}>Sự kiện</Text>
          <View style={{ width: 28 }} />
        </View>

        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          <View style={styles.comingSoon}>
            <Ionicons name="calendar-outline" size={80} color={theme.accentHex} />
            <Text style={[styles.title, { fontFamily: theme.fontFamily }]}>Sắp ra mắt!</Text>
            <Text style={[styles.subtitle, { fontFamily: theme.fontFamily }]}>Tính năng Đặt vé Sự kiện & Show diễn đang được nâng cấp.</Text>
