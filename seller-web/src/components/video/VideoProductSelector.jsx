...
export default function VideoProductSelector({ catalogProducts = [], selectedIds = [], onToggleSelect }) {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
          Đã chọn: <strong className="green-text">{selectedIds.length}</strong> sản phẩm từ Product Catalog
        </span>
